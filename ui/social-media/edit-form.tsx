...
import { StateSocialMedia, updateSocialMedia } from "@/lib/actions";
...
export default function EditSocialMediaForm({
  ...
  const initialState: Omit<StateSocialMedia, "inputs"> = {
    message: null,
    errors: {},
  };

  const updateSocialMediaWithId = updateSocialMedia.bind(null, socialMedia.id);

  const [platform, setPlatform] = useState<string | null>(socialMedia.platform);
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              defaultValue={socialMedia.title}
              className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  defaultChecked={socialMedia.qrcode}
                  className="h-4 w-4 cursor-pointer border-gray-300 focus:ring-2"
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              type="date"
              defaultValue={
                socialMedia.show_until &&
                new Date(socialMedia.show_until).toISOString().split("T")[0]
              }
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit" disabled={isPending}>
          ...
          <span className="hidden sm:block">
            {isPending ? "Saving..." : "Edit Social Media"}
          </span>
        </Button>
      </div>
    </form>
